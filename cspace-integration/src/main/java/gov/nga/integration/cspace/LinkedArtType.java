/*
    NGA ART DATA API: LinkedArtType extends the classified type and sets 
    its Type as "Type" thus representing the Linked Art Entity "Type" which requires
    additional refinement via labels and / or value, and / or classifications
