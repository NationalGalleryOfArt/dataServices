/*
    NGA Art Data API: Art Entity for Constituent - a constituent is an actor
    in the world of art, e.g. an owner, collector, donor, artist, etc. These 
    constituents have relationships to art objects in the sense of performing
    some action. 
