/*
    NGA Art Data API: ResearchImage typically represent images not produced by the 
    NGA's visual light imaging department and are images that supplement scholarly
    discovery or communications such as essays, online scholarly editions, conservation
    work, etc.  Just like the rest of the image classes, this one requires a large
    refactoring to make it more IIIF and eDAM friendly.
