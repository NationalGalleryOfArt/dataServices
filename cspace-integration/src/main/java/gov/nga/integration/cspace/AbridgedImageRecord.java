/*
    NGA ART DATA API: AbridgedImageRecord provides for the JSON bean container for the shortened 
    image records returned in references and via search results.   
