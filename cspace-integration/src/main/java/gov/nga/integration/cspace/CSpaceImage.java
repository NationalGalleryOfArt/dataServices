/*
    NGA ART DATA API: CSpaceImage is the base class for images in the data access api. Services that return
    imagery implement interfaces that return CSpaceImage(s).   
